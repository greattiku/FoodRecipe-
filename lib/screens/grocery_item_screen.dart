...
class BuildImportanceField extends StatefulWidget {
 final GroceryItem? item;
  const BuildImportanceField({super.key,
  this.item,
  });

  @override
  State<BuildImportanceField> createState() => _BuildImportanceFieldState();
}

class _BuildImportanceFieldState extends State<BuildImportanceField> {
   Importance _importance = Importance.low;
  @override
  Widget build(BuildContext context) {
    return Column(
...
class BuildDateField extends StatefulWidget {
  const BuildDateField({super.key});
...
class BuildTimeField extends StatefulWidget {
  const BuildTimeField({super.key});
...
// class BuildQualityField extends StatefulWidget {
//   const BuildQualityField({super.key});

//   @override
//   State<BuildQualityField> createState() => _BuildQualityFieldState();
// }

// class _BuildQualityFieldState extends State<BuildQualityField> {
//     Color _currentColor = Colors.green;
//   int _currentSliderValue = 0;
//   @override
//   Widget build(BuildContext context) {
